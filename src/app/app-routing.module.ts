...
// aplicação
import { ArtigoAutorGuard } from './pages/artigo/guard/artigo-autor.guard';
...
const routes: Routes = [
  ...
  { path: 'artigo/:id', loadChildren: () => import('./pages/artigo/artigo.module').then(mod => mod.ArtigoModule), canActivate: [UserRoleGuard, ArtigoAutorGuard] },
